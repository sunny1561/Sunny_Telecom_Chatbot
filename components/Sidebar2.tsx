...
// import { MessageSquare, Plus, Loader2, MoreHorizontal, FileDown } from 'lucide-react';
...
//               <h3 className="px-4 mb-2 text-sm font-semibold text-gray-500">{date}</h3>
//               {chatsInGroup.map(chat => (
//                 <div key={chat._id} className="flex items-center justify-between px-4 py-2 text-sm hover:bg-gray-100">
